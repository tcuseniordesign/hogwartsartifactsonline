...
/*
@RestControllerAdvice will only kick in if an exception is thrown from within a controller method, so it will inevitably not catch all things.
...
public class ExceptionHandlerAdvice {
    ...
    public Result handleNoHandlerFoundException(NoHandlerFoundException ex) {
        return new Result(false, StatusCode.NOT_FOUND, "Bad URL.", ex.getMessage());
    }
