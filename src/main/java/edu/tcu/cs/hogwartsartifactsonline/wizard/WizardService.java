...
public class WizardService {
    ...
    public void assignArtifact(Integer wizardId, String artifactId) {
        ...
        if (artifactToBeAssigned.getOwner() != null) {
            artifactToBeAssigned.getOwner().removeArtifact(artifactToBeAssigned); // This method includes removing the previous owner of this artifact.
        }
        wizard.addArtifact(artifactToBeAssigned); // This method includes setting the owner for this artifact.
    }
