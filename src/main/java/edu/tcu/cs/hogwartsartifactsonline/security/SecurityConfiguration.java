...
public class SecurityConfiguration {
    ...
    public SecurityConfiguration(CustomBasicAuthenticationEntryPoint customBasicAuthenticationEntryPoint,
        ...
        KeyPairGenerator keyPairGenerator = KeyPairGenerator.getInstance("RSA"); // Return a KeyPairGenerator object that generates public/private key pairs for the specified algorithm RSA.
        keyPairGenerator.initialize(2048); // Initialize the key pair generator for a certain keysize. In this case the generated key will have a size of 2048 bits.
